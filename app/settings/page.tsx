...
export default function SettingsPage() {
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center justify-center py-20">
            <div className="text-center">
              ...
              <p className={`${isDark ? 'text-[#A1A1AA]' : 'text-gray-600'}`}>Loading settings...</p>
            </div>
          </div>
        </main>
        <Footer />
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-black' : 'bg-white'}`}>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          <h1 className={`text-4xl font-bold mb-2 ${isDark ? 'text-white' : 'text-black'}`}>Settings</h1>
          <p className={`${isDark ? 'text-[#A1A1AA]' : 'text-gray-600'}`}>Manage your account connections and preferences</p>
        </div>

        <div className="space-y-6">
          {/* Connected Services */}
          <div className={`${isDark ? 'bg-[#0a0a0a] border border-[#333333]' : 'bg-white border border-gray-300'} rounded-lg p-6`}>
            <h2 className={`text-xl font-bold mb-6 ${isDark ? 'text-white' : 'text-black'}`}>Connected Services</h2>
            ...
            <div className="mb-6 pb-6 border-b border-[#333333]">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className={`font-semibold ${isDark ? 'text-white' : 'text-black'}`}>GitHub</h3>
                    {githubUser ? (
                      <p className={`text-sm ${isDark ? 'text-[#A1A1AA]' : 'text-gray-600'}`}>Connected as @{githubUser.login}</p>
                    ) : (
                      <p className={`text-sm ${isDark ? 'text-[#A1A1AA]' : 'text-gray-600'}`}>Not connected</p>
                    )}
                  </div>
                </div>
                {githubUser ? (
