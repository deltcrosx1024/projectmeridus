...
export default function DiscordStatus() {
  ...
  if (isLoading) {
    return (
      <div className={`border rounded-lg p-6 ${isDark ? 'bg-[#0f0f0f] border-[#333333]' : 'bg-white border-gray-300'}`}>
  ...
  return (
    <div className={`border rounded-lg p-6 mb-16 ${isDark ? 'bg-[#0f0f0f] border-[#333333]' : 'bg-white border-gray-300'}`}>
      {/* ===== HEADER ===== */}
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className={`text-xl font-bold ${isDark ? 'text-white' : 'text-black'}`}>Discord Status</h2>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-48 flex-shrink-0">
          <div className={`text-sm font-semibold mb-3 ${isDark ? 'text-[#A1A1AA]' : 'text-gray-600'}`}>Status Legend</div>
