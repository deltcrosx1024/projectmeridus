                  ...
                  {showGithubMenu && (
                    <div className="absolute right-0 mt-2 w-48 bg-slate-800 rounded-lg shadow-lg py-2 z-10">
                      <div className="px-4 py-2 border-b border-slate-700">
                        <p className="text-sm font-semibold">{githubUser.name}</p>
                        <p className="text-xs text-slate-400">{githubUser.bio}</p>
                      </div>
                      <a 
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-2 text-sm hover:bg-slate-700 text-red-400"
                      >
                        Logout
                      </button>
                    </div>
              ...
              {discordUser ? (
                <>
                  ...
                  {showDiscordMenu && (
                    <div className="absolute right-0 mt-2 w-48 bg-slate-800 rounded-lg shadow-lg py-2 z-10">
                      <div className="px-4 py-2 border-b border-slate-700">
                        <p className="text-sm font-semibold">{discordUser.username}</p>
                        <p className="text-xs text-slate-400">ID: {discordUser.id}</p>
                      </div>
                      <button
                        onClick={() => {
                          logout('discord');
