  ...
  const sections: DocSection[] = [
    {
      ...
      content: (
        <>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">What is Meridus?</h3>
          <p className="text-[var(--muted)] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Prerequisites</h3>
          <p className="text-[var(--muted)] mb-4">
            Before using Meridus, you'll need accounts with these services:
          </p>
          <ul className="list-disc list-inside text-[var(--muted)] mb-6 space-y-2">
            <li><strong className="text-[var(--foreground)]">GitHub</strong> - Required for repository data</li>
            <li><strong className="text-[var(--foreground)]">Discord</strong> - Optional, for status viewing</li>
            <li><strong className="text-[var(--foreground)]">Vercel</strong> - Optional, for deployment tracking</li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Connecting GitHub (Required)</h3>
          <p className="text-[var(--muted)] mb-4">
            GitHub is the core of Meridus - without it, there's not much to show. Here's how to connect:
          </p>
          <ol className="list-decimal list-inside text-[var(--muted)] mb-6 space-y-3">
            <li>Look for the <span className="text-[var(--foreground)]">GitHub</span> button in the top right of the header</li>
          ...
          <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-lg p-4 mb-6">
            <h4 className="text-[var(--foreground)] font-semibold mb-2">Why does Meridus need these permissions?</h4>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Connecting Discord (Optional)</h3>
          <p className="text-[var(--muted)] mb-4">
          ...
          <ol className="list-decimal list-inside text-[var(--muted)] mb-6 space-y-3">
            <li>Click the <span className="text-[var(--foreground)]">Discord</span> button in the header</li>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Connecting Vercel (Optional)</h3>
          <p className="text-[var(--muted)] mb-4">
          ...
          <ol className="list-decimal list-inside text-[var(--muted)] mb-6 space-y-3">
            <li>Click the <span className="text-[var(--foreground)]">Vercel</span> button in the header</li>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Stats Grid (The Top Cards)</h3>
          <p className="text-[var(--muted)] mb-4">
            The four cards at the top give you a quick snapshot:
          </p>
          <ul className="list-disc list-inside text-[var(--muted)] mb-6 space-y-2">
            <li><strong className="text-[var(--foreground)]">Total Repositories</strong> - How many repos you have (both public)</li>
            <li><strong className="text-[var(--foreground)]">Active Issues</strong> - Issues currently open across all your repos</li>
            <li><strong className="text-[var(--foreground)]">Pull Requests</strong> - Open PRs waiting for review or merge</li>
            <li><strong className="text-[var(--foreground)]">Followers</strong> - Your GitHub followers (community size indicator)</li>
          </ul>

          {/* IMAGE PLACEHOLDER: Add screenshot of stats grid */}
          {/* TODO: Add screenshot showing the stats grid with real numbers */}

          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">API Response Times (Expandable)</h3>
          <p className="text-[var(--muted)] mb-4">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Discord Status</h3>
          <p className="text-[var(--muted)] mb-4">
          ...
          <ul className="list-disc list-inside text-[var(--muted)] mb-6 space-y-2">
            <li><strong className="text-[var(--foreground)]">API</strong> - Core messaging and user operations</li>
            <li><strong className="text-[var(--foreground)]">Gateway</strong> - Real-time connections (voice, presence)</li>
            <li><strong className="text-[var(--foreground)]">Media Proxy</strong> - Image/video hosting</li>
            <li><strong className="text-[var(--foreground)]">Search</strong> - Message search functionality</li>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">What's on the Insights Page?</h3>

          <h4 className="text-lg font-medium text-[var(--foreground)] mb-3">Contribution Graph</h4>
          <p className="text-[var(--muted)] mb-4">
          ...
          <h4 className="text-lg font-medium text-[var(--foreground)] mb-3">Repository Stats</h4>
          <p className="text-[var(--muted)] mb-4">
          ...
          <h4 className="text-lg font-medium text-[var(--foreground)] mb-3">Top Repositories</h4>
          <p className="text-[var(--muted)] mb-4">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">API & Status Section</h3>
          <p className="text-[var(--muted)] mb-4">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">What Information is Shown?</h3>
          <ul className="list-disc list-inside text-[var(--muted)] mb-6 space-y-2">
            <li><strong className="text-[var(--foreground)]">Repository Name</strong> - Click to open on GitHub</li>
            <li><strong className="text-[var(--foreground)]">Description</strong> - What the repo is about</li>
            <li><strong className="text-[var(--foreground)]">Language</strong> - Primary language (JavaScript, Python, etc.)</li>
            <li><strong className="text-[var(--foreground)]">Stars & Forks</strong> - Popularity metrics</li>
            <li><strong className="text-[var(--foreground)]">Last Updated</strong> - When the repo was last modified</li>
          </ul>

          {/* IMAGE PLACEHOLDER: Add screenshot of repositories page */}
          {/* TODO: Add screenshot showing the repositories list with all columns */}

          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">How to Use It</h3>
          <p className="text-[var(--muted)] mb-4">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Auto-Refresh</h3>
          <p className="text-[var(--muted)] mb-4">
            By default, Meridus automatically refreshes your data every 5 minutes. 
            You can adjust this or turn it off entirely:
          </p>
          <ul className="list-disc list-inside text-[var(--muted)] mb-6 space-y-2">
            <li><strong className="text-[var(--foreground)]">Enable/Disable</strong> - Turn auto-refresh on or off</li>
            <li><strong className="text-[var(--foreground)]">Refresh Interval</strong> - How often (1-30 minutes)</li>
          </ul>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Theme</h3>
          <p className="text-[var(--muted)] mb-4">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Notifications</h3>
          <p className="text-[var(--muted)] mb-4">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">What Can the Bot Do?</h3>
          <p className="text-[var(--muted)] mb-4">
            The Meridus bot can:
          </p>
          <ul className="list-disc list-inside text-[var(--muted)] mb-6 space-y-2">
            <li><strong className="text-[var(--foreground)]">Respond to commands</strong> - Slash commands for various actions</li>
            <li><strong className="text-[var(--foreground)]">Webhook integration</strong> - Receive events from GitHub, Vercel, etc.</li>
            <li><strong className="text-[var(--foreground)]">Send notifications</strong> - Post updates to your server channels</li>
          </ul>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Adding the Bot to Your Server</h3>
          <p className="text-[var(--muted)] mb-4">
          ...
          <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-lg p-4 mb-6">
            <h4 className="text-[var(--foreground)] font-semibold mb-2">Important Permissions</h4>
            <p className="text-[var(--muted)] text-sm">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Bot Commands</h3>
          <p className="text-[var(--muted)] mb-4">
            Once the bot is in your server, you can use these slash commands:
          </p>
          <ul className="list-disc list-inside text-[var(--muted)] mb-6 space-y-2">
            <li><code className="bg-[var(--card-border)]/20 px-2 py-1 rounded text-green-400">/help</code> - Show available commands</li>
            <li><code className="bg-[var(--card-border)]/20 px-2 py-1 rounded text-green-400">/status</code> - Check Discord API status</li>
            <li><code className="bg-[var(--card-border)]/20 px-2 py-1 rounded text-green-400">/ping</code> - Check bot responsiveness</li>
          </ul>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Setting Up Webhooks</h3>
          <p className="text-[var(--muted)] mb-4">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">"Not authenticated" Errors</h3>
          <p className="text-[var(--muted)] mb-2">
            <strong className="text-[var(--foreground)]">Symptoms:</strong> You're trying to view something but get an error saying you need to log in.
          </p>
          <p className="text-[var(--muted)] mb-4">
            <strong className="text-[var(--foreground)]">Fix:</strong> Make sure you've connected the relevant account (GitHub for repos, Discord for status, etc.).
            Check the header - if you don't see your profile picture, you're not logged in.
          </p>

          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Data Not Loading</h3>
          <p className="text-[var(--muted)] mb-2">
            <strong className="text-[var(--foreground)]">Symptoms:</strong> The page just spins or shows loading forever.
          </p>
          <p className="text-[var(--muted)] mb-4">
            <strong className="text-[var(--foreground)]">Fix:</strong> Try these steps:
          </p>
          <ol className="list-decimal list-inside text-[var(--muted)] mb-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Slow Response Times</h3>
          <p className="text-[var(--muted)] mb-2">
            <strong className="text-[var(--foreground)]">Symptoms:</strong> The API metrics show red (over 500ms) consistently.
          </p>
          <p className="text-[var(--muted)] mb-4">
            <strong className="text-[var(--foreground)]">Fix:</strong> This is usually on our end or the external service's end:
          </p>
          <ul className="list-disc list-inside text-[var(--muted)] mb-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Bot Not Responding</h3>
          <p className="text-[var(--muted)] mb-2">
            <strong className="text-[var(--foreground)]">Symptoms:</strong> You typed a command but nothing happens.
          </p>
          <p className="text-[var(--muted)] mb-4">
            <strong className="text-[var(--foreground)]">Fix:</strong> 
          </p>
          <ol className="list-decimal list-inside text-[var(--muted)] mb-6 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Still Stuck?</h3>
          <p className="text-[var(--muted)] mb-4">
    ...
    },
    {
      ...
      content: (
        <>
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Is Meridus free?</h3>
          <p className="text-[var(--muted)] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Is my data secure?</h3>
          <p className="text-[var(--muted)] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Why do you need access to my repositories?</h3>
          <p className="text-[var(--muted)] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Can I use Meridus without connecting all three services?</h3>
          <p className="text-[var(--muted)] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">How often is the data refreshed?</h3>
          <p className="text-[var(--muted)] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">The bot isn't working in my server</h3>
          <p className="text-[var(--muted)] mb-6">
          ...
          <h3 className="text-xl font-semibold text-[var(--foreground)] mb-4">Can I suggest new features?</h3>
          <p className="text-[var(--muted)] mb-6">
            ...
            <nav className="sticky top-24 space-y-1">
              {!isHydrated ? (
                <div className="animate-pulse space-y-2">
                  {[...Array(9)].map((_, i) => (
                    <div key={i} className="h-10 bg-[var(--card-border)]/20 rounded-lg"></div>
                  ))}
                </div>
              ) : (
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 rounded-lg transition-colors ${
                      activeSection === section.id
                        ? 'bg-[#0070F3] text-[var(--foreground)]'
                        : 'text-[var(--muted)] hover:bg-[var(--card-border)]/20 hover:text-[var(--foreground)]'
                    }`}
                  >
                    {section.title}
                  </button>
          ...
          <div className="flex-1 min-w-0">
            {!isHydrated ? (
              <div className="animate-pulse space-y-4">
                <div className="h-8 bg-[var(--card-border)]/20 rounded w-1/3"></div>
                <div className="h-4 bg-[var(--card-border)]/20 rounded w-full"></div>
                <div className="h-4 bg-[var(--card-border)]/20 rounded w-5/6"></div>
                <div className="h-4 bg-[var(--card-border)]/20 rounded w-4/5"></div>
              </div>
            ) : (
              sections.map((section) => (
                <div
                ...
                >
                  <h2 className="text-3xl font-bold text-[var(--foreground)] mb-6">{section.title}</h2>
